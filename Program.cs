            ...
            var config1 = new AutoMapper.MapperConfiguration(cfg =>
     {
         cfg.CreateMap<ComputerSnake, Computer>()
            ...
            if (computerSystem != null)
            {
                ...
                Console.WriteLine("Mapper result count: "+computerResult.Count());
            ...
            IEnumerable<Computer>? computerSystemJsonProperty = System.Text.Json.JsonSerializer.Deserialize<IEnumerable<Computer>>(ComputerJson2, options);

            Console.WriteLine("JsonProperty result count: " + computerSystemJsonProperty?.Count()); 

            // if(computerSystemJsonProperty != null)
            // {
            //     foreach(Computer computer in computerSystemJsonProperty)
            //     {
            //         Console.WriteLine(computer.Motherboard);
            //     }
